...
contract Example04 {
    ...
    event sendInContract(uint256 indexed amount, address indexed addr, string func);
    ...
    receive() external payable {
        emit sendInContract(msg.value, msg.sender, "receive");
    }

    fallback() external payable {
        emit sendInContract(msg.value, msg.sender, "fallback");
    }
}
